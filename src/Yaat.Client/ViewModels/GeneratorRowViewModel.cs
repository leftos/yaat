...
public partial class GeneratorRowViewModel : ObservableObject
{
    ...
    // Nullable: an omitted maxTime means "runs for the whole session". Materializing a default here would
    // silently exhaust an unbounded generator the first time an instructor opened the editor and pressed Apply.
    [ObservableProperty]
