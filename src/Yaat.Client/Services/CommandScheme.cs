    ...
    public static CommandScheme Default()
    {
        return new CommandScheme
        {
            Patterns = new Dictionary<CanonicalCommandType, CommandPattern>
            {
                ...
                [CanonicalCommandType.ReduceToFinalApproachSpeed] = new() { Aliases = ["RFAS", "FAS"], Format = "{verb}" },
                [CanonicalCommandType.DeleteSpeedRestrictions] = new() { Aliases = ["DSR"], Format = "{verb}" },
                [CanonicalCommandType.Expedite] = new() { Aliases = ["EXP"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.NormalRate] = new() { Aliases = ["NORM"], Format = "{verb}" },
                [CanonicalCommandType.Mach] = new() { Aliases = ["MACH", "M"], Format = "{verb} {arg}" },
                ...
                [CanonicalCommandType.AppendForceDirectTo] = new() { Aliases = ["ADCTF"], Format = "{verb} {arg}" },
                // Tower
                ...
                [CanonicalCommandType.EnterLeftCrosswind] = new() { Aliases = ["ELC"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.EnterRightCrosswind] = new() { Aliases = ["ERC"], Format = "{verb} {arg?}" },
                ...
                [CanonicalCommandType.MakeLeftTraffic] = new() { Aliases = ["MLT"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.MakeRightTraffic] = new() { Aliases = ["MRT"], Format = "{verb} {arg?}" },
                ...
                [CanonicalCommandType.MakeNormalApproach] = new() { Aliases = ["MNA"], Format = "{verb}" },
                [CanonicalCommandType.Cancel270] = new() { Aliases = ["NO270"], Format = "{verb}" },
                ...
                [CanonicalCommandType.PatternSize] = new() { Aliases = ["PS", "PATTSIZE"], Format = "{verb} {arg}" },
                [CanonicalCommandType.MakeLeftSTurns] = new() { Aliases = ["MLS"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.MakeRightSTurns] = new() { Aliases = ["MRS"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.Plan270] = new() { Aliases = ["P270", "PLAN270"], Format = "{verb}" },
                ...
                [CanonicalCommandType.Scratchpad1] = new() { Aliases = ["SP1"], Format = "{verb} {arg}" },
                [CanonicalCommandType.Scratchpad2] = new() { Aliases = ["SP2"], Format = "{verb} {arg}" },
                ...
                // Queue
                [CanonicalCommandType.DeleteQueuedCommands] = new() { Aliases = ["DELAT"], Format = "{verb} {arg?}" },
                [CanonicalCommandType.ShowQueuedCommands] = new() { Aliases = ["SHOWAT"], Format = "{verb}" },
                // Consolidation
