...
public static class CommandMetadata
{
    ...
    [
        ...
        // Pattern
        new(CanonicalCommandType.EnterLeftDownwind, "Enter Left Downwind", null, false),
        new(CanonicalCommandType.EnterRightDownwind, "Enter Right Downwind", null, false),
        new(CanonicalCommandType.EnterLeftBase, "Enter Left Base", null, false),
        new(CanonicalCommandType.EnterRightBase, "Enter Right Base", null, false),
        new(CanonicalCommandType.EnterFinal, "Enter Final", null, false),
