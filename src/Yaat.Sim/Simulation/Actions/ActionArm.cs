...
public static class ArmTable
{
    ...
    private static FrozenDictionary<RecordedCommandKind, ActionArm> Build()
    {
        var rows = new List<ActionArm>
        {
            ...
            Sim(RecordedCommandKind.AcceptAllHandoffs, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.InitiateHandoffAll, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.GhostTrack, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.Reposition, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.SquawkAll, ActionArms.SquawkAll),
            Sim(RecordedCommandKind.TaxiAll, ActionArms.NotAvailable),
            ...
            Sim(RecordedCommandKind.Consolidate, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.Deconsolidate, ActionArms.NotAvailable),
            Sim(RecordedCommandKind.AddAircraft, ActionArms.NotAvailable),
