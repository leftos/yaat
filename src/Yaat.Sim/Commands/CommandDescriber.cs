...
public static class CommandDescriber
{
    ...
    public static string DescribeCommand(ParsedCommand command)
    {
        return command switch
        {
            ...
            ExitLeftCommand el => el.Taxiway is not null ? $"EL {el.Taxiway}" : "EL",
            ExitRightCommand er => er.Taxiway is not null ? $"ER {er.Taxiway}" : "ER",
    ...
    internal static string DescribeNatural(ParsedCommand command)
    {
        return command switch
        {
            ...
            ExitLeftCommand el => el.Taxiway is not null ? $"Exit left at {el.Taxiway}" : "Exit left",
            ExitRightCommand er => er.Taxiway is not null ? $"Exit right at {er.Taxiway}" : "Exit right",
