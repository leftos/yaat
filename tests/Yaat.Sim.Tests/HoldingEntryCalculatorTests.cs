...
public class HoldingEntryCalculatorTests
{
    ...
    {
        HoldingEntry result = HoldingEntryCalculator.ComputeEntry(new TrueHeading(heading), inboundCourse, dir);
    ...
    public void WraparoundHeading_CorrectEntry()
    {
        ...
        HoldingEntry result = HoldingEntryCalculator.ComputeEntry(new TrueHeading(350), 10, TurnDirection.Right);
