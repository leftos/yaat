...
public class WaitCommandDispatchTests
{
    ...
    public void WaitCommand_Standalone_DuringPushback_IsRejected()
    {
        ...
        var result = CommandDispatcher.DispatchCompound(WaitCompound(15), ac, null, new SerializableRandom(42), true);
    ...
    public void WaitCommand_Standalone_WithoutPhases_IsAccepted()
    {
        ...
        var result = CommandDispatcher.DispatchCompound(WaitCompound(10), ac, null, new SerializableRandom(42), true);
