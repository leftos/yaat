...
public class WaitCommandDispatchTests
{
    ...
    public void WaitCommand_Standalone_DuringPushback_IsRejected()
    {
        ...
        var result = CommandDispatcher.DispatchCompound(WaitCompound(15), ac, null, null, null, new Random(42), null, null, true);
    ...
    public void WaitCommand_Standalone_WithoutPhases_IsAccepted()
    {
        ...
        var result = CommandDispatcher.DispatchCompound(WaitCompound(10), ac, null, null, null, new Random(42), null, null, true);
