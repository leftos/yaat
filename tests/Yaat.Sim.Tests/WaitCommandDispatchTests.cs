...
public class WaitCommandDispatchTests
{
    ...
    private static CompoundCommand WaitCompound(double seconds) => new([new ParsedBlock(null, [new WaitCommand(seconds)])]);
    ...
    public void BehindPush_AtParking_CreatesDeferredDispatch()
    {
        ...
        var compound = new CompoundCommand([new ParsedBlock(new GiveWayCondition("UAL999"), [new PushbackCommand(null, "T9", null, null, false)])]);
