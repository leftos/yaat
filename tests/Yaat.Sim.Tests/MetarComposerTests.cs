...
public class MetarComposerTests
{
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(calm: true), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(dir: 360, speed: 8, gust: 18), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(vis: vis), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(layers: []), Obs, isSpeci: false);
    ...
    public void Compose_HighCloudsAboveAutomatedLimit_ReportedClear()
    {
        ...
        string result = MetarComposer.Compose(Base, Cond(layers: layers), Obs, isSpeci: false);
        Assert.Contains("CLR", result);
    ...
    public void Compose_MultipleLayers_EmitsSortedSky()
    {
        ...
        string result = MetarComposer.Compose(Base, Cond(layers: layers, ceiling: 1500), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(alt: inHg), Obs, isSpeci: false);
        Assert.Contains(expected, result);
    }
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(), Obs, isSpeci: true);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(alt: 29.96), Obs, isSpeci: false);
    ...
    public void Compose_StripsPeriodRelativeRemarks()
    {
        ...
        string result = MetarComposer.Compose(withWindRemarks, Cond(), Obs, isSpeci: false);
    ...
    public void Compose_LeadingMetarKeyword_NotDuplicated()
    {
        ...
        string result = MetarComposer.Compose(withKeyword, Cond(), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(speed: 5, variable: true), Obs, isSpeci: false);
    ...
    {
        string result = MetarComposer.Compose(Base, Cond(dir: 210, speed: 15, varFrom: 180, varTo: 240), Obs, isSpeci: false);
    ...
    public void Compose_VarGroup_ReplacesBaseGroup()
    {
        ...
        string result = MetarComposer.Compose(withVar, Cond(dir: 220, speed: 16, varFrom: 190, varTo: 260), Obs, isSpeci: false);
    ...
    {
        const string withVar = "KOAK 121853Z 21015KT 170V250 10SM FEW025 18/12 A2992";
        string result = MetarComposer.Compose(withVar, Cond(dir: 210, speed: 15), Obs, isSpeci: false);
    ...
    public void Compose_PeakWind_EmitsRemark()
    {
        ...
        string result = MetarComposer.Compose(
            Base,
