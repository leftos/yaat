...
public class NavigationCommandTests
{
    ...
    public void Jrado_InterceptBlockSetsRadialHeading()
    {
        ...
        CommandDispatcher.Dispatch(cmd, aircraft, null, null, null, Logger, Random.Shared);
    ...
    public void Apps_NoAirportAndNoDestination_ReturnsError()
    {
        ...
        var result = CommandDispatcher.Dispatch(cmd, aircraft, null, null, null, Logger, Random.Shared, approachDb);
    ...
    public void HoldingPattern_AnyCommandExitsPhase()
    {
        ...
        CommandDispatcher.Dispatch(holdCmd, aircraft, null, null, null, Logger, Random.Shared);
