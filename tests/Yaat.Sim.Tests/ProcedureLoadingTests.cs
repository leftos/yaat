...
public class ProcedureLoadingTests
{
    ...
    public void Jarr_WithCifp_LoadsConstrainedTargets()
    {
        ...
        var result = CommandDispatcher.Dispatch(cmd, aircraft, null, null, fixes, Logger, procedureLookup: procedures);
    ...
    public void Jarr_SetsActiveStarId_StarViaModeOff()
    {
        ...
        var cmd = new JoinStarCommand("BDEGA3", "BDEGA");
        CommandDispatcher.Dispatch(cmd, aircraft, null, null, fixes, Logger, procedureLookup: procedures);
