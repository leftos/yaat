...
public class ResumeAssignedAltitudeAfterPhaseClearTests
{
    ...
    public void Climbing_ResumesAssignedAltitude()
    {
        ...
        AircraftState ac = Make(altitude: 335, onGround: false, assigned: 1400, target: 409);
    ...
    public void DescendingBelowAssigned_DoesNotClimbBack()
    {
        ...
        AircraftState ac = Make(altitude: 1500, onGround: false, assigned: 2000, target: 1300);
        CommandDispatcher.ResumeAssignedAltitudeAfterPhaseClear(ac, clearedGoAround: false);
    ...
    {
        AircraftState ac = Make(altitude: 1400, onGround: false, assigned: 1400, target: null);
        CommandDispatcher.ResumeAssignedAltitudeAfterPhaseClear(ac, clearedGoAround: false);
    ...
    {
        AircraftState ac = Make(altitude: 9, onGround: true, assigned: 1400, target: 409);
        CommandDispatcher.ResumeAssignedAltitudeAfterPhaseClear(ac, clearedGoAround: false);
    ...
    {
        AircraftState ac = Make(altitude: 800, onGround: false, assigned: null, target: 800);
        CommandDispatcher.ResumeAssignedAltitudeAfterPhaseClear(ac, clearedGoAround: false);
    ...
    public void GoAroundMapAboveAssigned_DoesNotLowerTarget()
    {
        ...
        AircraftState ac = Make(altitude: 500, onGround: false, assigned: 3000, target: 4000);
    ...
    public void GoAroundMapBelowAssigned_HoldsMapAltitude()
    {
        ...
        AircraftState ac = Make(altitude: 500, onGround: false, assigned: 3000, target: 2000);
        CommandDispatcher.ResumeAssignedAltitudeAfterPhaseClear(ac, clearedGoAround: true);
