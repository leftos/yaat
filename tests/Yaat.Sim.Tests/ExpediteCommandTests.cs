...
public class ExpediteCommandTests
{
    ...
    public void Expedite_SetsFlag_WhenClimbing()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ExpediteCommand(), ac, null, null, null, Random.Shared, null, null, true);
    ...
    public void NormalRate_ClearsFlag()
    {
        ...
        var result = CommandDispatcher.Dispatch(new NormalRateCommand(), ac, null, null, null, Random.Shared, null, null, true);
    ...
    public void ClimbMaintain_ClearsExpediteFlag()
    {
        ...
        CommandDispatcher.Dispatch(new ClimbMaintainCommand(15000), ac, null, null, null, Random.Shared, null, null, true);
    ...
    public void DescendMaintain_ClearsExpediteFlag()
    {
        ...
        CommandDispatcher.Dispatch(new DescendMaintainCommand(3000), ac, null, null, null, Random.Shared, null, null, true);
    ...
    public void ExpediteWithAltitude_AddsQueueBlock()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ExpediteCommand(10000), ac, null, null, null, Random.Shared, null, null, true);
