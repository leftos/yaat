...
public class CommandQueueTests
{
    ...
    {
        LatLon pos = position ?? new LatLon(37.7, -122.2);
    ...
    {
        AircraftState ac = MakeAircraft(altitude: 5_000);
    ...
    public void ReachAltitude_Met_WhenWithinSnapRange()
    {
        ...
        AircraftState ac = MakeAircraft(altitude: 9_995);
        ac.Queue.Blocks.Add(TriggeredBlock(new BlockTrigger { Type = BlockTriggerType.ReachAltitude, Altitude = 10_000 }));
    ...
    public void ReachFix_NotMet_WhenFar()
    {
        ...
        AircraftState ac = MakeAircraft(new LatLon(37.7, -122.2));
        ac.Queue.Blocks.Add(
            TriggeredBlock(
                new BlockTrigger
                {
    ...
    public void GiveWay_Met_WhenTargetAirborne()
    {
        ...
        AircraftState target = MakeAircraft(new LatLon(37.7001, -122.2));
    ...
    public void GiveWay_Met_WhenTargetFarAheadSameDirection()
    {
        ...
        AircraftState target = MakeAircraft(new LatLon(37.7, -122.2 + lonOffset));
        target.Callsign = "OTHER";
    ...
    public void AdvancesToNextBlock_WhenAllComplete()
    {
        ...
        AircraftState ac = MakeAircraft();
        CommandBlock firstBlock = ImmediateBlock();
        CommandBlock secondBlock = ImmediateBlock();
    ...
    {
        AircraftState ac = MakeAircraft(heading: 090);
        var block = new CommandBlock
        {
            Commands = [new TrackedCommand { Type = TrackedCommandType.Immediate }],
            ApplyAction = a =>
    ...
    public void ReadyToAdvance_PhysicsTick_AdvancesOnLateralCompletion()
    {
        ...
        CommandBlock block1 = ImmediateBlock();
    ...
    public void GetCompoundDimensions_UnionsAllBlocks()
    {
        ...
        CommandDimension dims = CommandDescriber.GetCompoundDimensions(compound);
