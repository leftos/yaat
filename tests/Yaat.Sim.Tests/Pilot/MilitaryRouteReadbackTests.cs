...
public sealed class MilitaryRouteReadbackTests
{
    ...
    private static PilotSpeechText Readback(AircraftState aircraft, string text)
    {
        ...
        PilotSpeechText? result = PilotResponder.BuildReadback(CommandParser.ParseCompound(text).Value!, aircraft);
    ...
    {
        PilotSpeechText result = Readback(Aircraft(null), "CMTR IR149");
    ...
    public void Cmtr_WithAssignedAltitude_ReadsBackTheAltitude()
    {
        ...
        PilotSpeechText result = Readback(Aircraft(null), "CMTR IR149 50");
    ...
    {
        PilotSpeechText result = Readback(Aircraft(null), "CMTR IR149 B50");
    ...
    public void Mtra_TakesItsDesignatorFromTheClearance()
    {
        ...
        PilotSpeechText result = Readback(Aircraft("IR149"), "MTRA");
    ...
    {
        ParseResult<CompoundCommand> parsed = CommandParser.ParseCompound("MTRA");
    ...
    {
        PilotSpeechText result = Readback(Aircraft("IR149"), "XMTR KTCM 240 VIA V495 SEA");
    ...
    {
        PilotSpeechText result = Readback(Aircraft("IR149"), "XMTR KTCM 240");
    ...
    {
        PilotSpeechText result = Readback(Aircraft("IR149"), "XMTR KTCM");
    ...
    public void Car_ReadsBackTheTrackWithoutSpeakingTheLetters()
    {
        ...
        PilotSpeechText result = Readback(Aircraft(null), "CAR AR1 240 310");
    ...
    {
        PilotSpeechText result = Readback(Aircraft(null), "CAR AR312");
    ...
    public void SayExit_ProducesNoReadback_BecauseThePilotAnswersInstead()
    {
        ...
        ParseResult<CompoundCommand> parsed = CommandParser.ParseCompound("SAYEXIT");
