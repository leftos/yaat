...
public class ProgrammedFixResolverTests
{
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve("SUNOL MODESTO OXNARD", null, null, null, null, null, null);
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve("PORTE.V25 CNDEL", null, null, null, null, null, null);
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve("", null, null, null, null, null, null);
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve(null, null, null, null, null, null, null);
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve("sunol MODESTO", null, null, null, null, null, null);
    ...
    public void Resolve_ActiveApproachFixes_Included()
    {
        ...
        HashSet<string> result = ProgrammedFixResolver.Resolve("SUNOL", null, null, null, approachFixes, null, null);
    ...
    public void Resolve_MultipleDotTokens_ExtractsAllFixes()
    {
        ...
        HashSet<string> result = ProgrammedFixResolver.Resolve("PORTE.V25 CNDEL.V244 SFO", null, null, null, null, null, null);
    ...
    public void Resolve_DotWithNoFixName_Skips()
    {
        ...
        HashSet<string> result = ProgrammedFixResolver.Resolve(".V25 CNDEL", null, null, null, null, null, null);
    ...
    {
        HashSet<string> result = ProgrammedFixResolver.Resolve("SUNOL MODESTO SUNOL", null, null, null, null, null, null);
