...
public class Issue162PushTaxiwayFilletTests(ITestOutputHelper output)
{
    ...
    public void FindExitByTaxiway_PrefersNodeWithStraightTaxiwayEdge()
    {
        ...
        GroundNode? target = layout.FindExitByTaxiway(fromPos, "T5B");
    ...
    public void DAL451_PushT5B_EndsNearStraightT5BEdge()
    {
        ...
        AircraftState? ac = engine.FindAircraft("DAL451");
        Assert.NotNull(ac);
        ...
        GroundNode nearest = layout.Nodes.Values.OrderBy(n => GeoMath.DistanceNm(ac.Position, n.Position)).First();
