...
public class SpeedCommandTests
{
    ...
    public void SpeedFloor_SetsFloorClearsTargetAndCeiling()
    {
        ...
        var result = CommandDispatcher.Dispatch(new SpeedCommand(210, SpeedModifier.Floor), ac, null, Random.Shared, true);
    ...
    public void SpeedCeiling_SetsCeilingClearsTargetAndFloor()
    {
        ...
        var result = CommandDispatcher.Dispatch(new SpeedCommand(210, SpeedModifier.Ceiling), ac, null, Random.Shared, true);
    ...
    public void SpeedExact_ClearsFloorAndCeiling()
    {
        ...
        var result = CommandDispatcher.Dispatch(new SpeedCommand(220), ac, null, Random.Shared, true);
    ...
    public void SpeedZero_SetsTargetSpeedZero()
    {
        ...
        var result = CommandDispatcher.Dispatch(new SpeedCommand(0), ac, null, Random.Shared, true);
    ...
    public void ResumeNormalSpeed_ClearsAllSpeed()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ResumeNormalSpeedCommand(), ac, null, Random.Shared, true);
    ...
    public void DeleteSpeedRestrictions_ClearsAllAndSetsDsrFlag()
    {
        ...
        var result = CommandDispatcher.Dispatch(new DeleteSpeedRestrictionsCommand(), ac, null, Random.Shared, true);
    ...
    public void SpeedCommand_ClearsDsrFlag()
    {
        ...
        CommandDispatcher.Dispatch(new SpeedCommand(210), ac, null, Random.Shared, true);
    ...
    public void Cvia_ClearsDsrFlag()
    {
        ...
        CommandDispatcher.Dispatch(new ClimbViaCommand(null), ac, null, Random.Shared, true);
    ...
    public void Dvia_ClearsDsrFlag()
    {
        ...
        CommandDispatcher.Dispatch(new DescendViaCommand(null), ac, null, Random.Shared, true);
    ...
    public void SpeedCommand_RejectedInside5nmFinal()
    {
        ...
        var result = CommandDispatcher.Dispatch(new SpeedCommand(180), ac, null, Random.Shared, true);
    ...
    public void SpeedFloorCommand_ThenCeilingCommand_ReplacesFloor()
    {
        ...
        CommandDispatcher.Dispatch(new SpeedCommand(200, SpeedModifier.Floor), ac, null, Random.Shared, true);
        Assert.Equal(200, ac.Targets.SpeedFloor);
        Assert.Null(ac.Targets.SpeedCeiling);

        CommandDispatcher.Dispatch(new SpeedCommand(250, SpeedModifier.Ceiling), ac, null, Random.Shared, true);
        Assert.Null(ac.Targets.SpeedFloor);
