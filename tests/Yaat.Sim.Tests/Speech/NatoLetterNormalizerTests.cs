...
public class NatoLetterNormalizerTests
{
    ...
    {
        List<string> result = NatoLetterNormalizer.Collapse([], EmptySet);
        Assert.Empty(result);
    }
    ...
    {
        List<string> result = NatoLetterNormalizer.Collapse(["tango"], EmptySet);
    ...
    {
        List<string> result = NatoLetterNormalizer.Collapse(["tango", "uniform", "whiskey"], EmptySet);
    ...
    public void Multi_Letter_Name_In_Set_Is_Used()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["tango", "echo"], TaxiwaySet("TE"));
    ...
    public void Multi_Letter_Name_Absent_From_Set_Splits_To_Single_Letters()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["tango", "echo"], TaxiwaySet("T", "E"));
    ...
    public void Longest_Match_Wins_When_Multiple_Prefixes_Exist()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["tango", "echo", "lima"], TaxiwaySet("TE", "TEL"));
    ...
    public void Greedy_Split_Falls_Back_After_Longest_Match_Consumed()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["tango", "echo", "mike"], TaxiwaySet("TE"));
    ...
    public void Run_Longer_Than_Max_Still_Splits_Cleanly()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["alpha", "bravo", "charlie", "delta", "echo"], EmptySet);
    ...
    public void November_In_Isolation_Collapses_To_N()
    {
        ...
        List<string> result = NatoLetterNormalizer.Collapse(["taxi", "via", "november"], EmptySet);
