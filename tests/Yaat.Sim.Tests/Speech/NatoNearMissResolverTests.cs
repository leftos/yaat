...
public class NatoNearMissResolverTests
{
    ...
    {
        List<string> result = NatoNearMissResolver.Resolve([], NoProtection);
        Assert.Empty(result);
    }
    ...
    {
        List<string> result = NatoNearMissResolver.Resolve(["runway", "taxi", "via"], NoProtection);
    ...
    public void Exact_Nato_Word_Passes_Through()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["tango", "golf", "november"], NoProtection);
    ...
    public void Tingo_Rewritten_To_Tango()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["tingo"], NoProtection);
    ...
    public void Gulf_Rewritten_To_Golf()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["gulf"], NoProtection);
    ...
    {
        List<string> result = NatoNearMissResolver.Resolve([input], NoProtection);
    ...
    public void Short_Token_Passes_Through()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["ech", "abc"], NoProtection);
    ...
    public void First_Character_Mismatch_Not_Rewritten()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["bingo"], NoProtection);
    ...
    public void Length_Diff_Greater_Than_One_Not_Rewritten()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["tang", "tangooo"], NoProtection);
    ...
    public void Protected_Fix_Is_Not_Rewritten()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["direct", "gulf"], Protect("GULF"));
    ...
    {
        List<string> result = NatoNearMissResolver.Resolve(["tingo"], Protect("TINGO"));
    ...
    public void Command_Word_Make_Is_Not_Rewritten_To_Mike()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["make", "left", "traffic"], NoProtection);
    ...
    public void Command_Word_Land_Is_Not_Rewritten_To_Lima()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["cleared", "to", "land"], NoProtection);
    ...
    public void Ambiguous_Match_Not_Rewritten()
    {
        ...
        List<string> result = NatoNearMissResolver.Resolve(["bovember"], NoProtection);
    ...
    {
        List<string> result = NatoNearMissResolver.Resolve(["taxi", "via", "tingo", "uniform", "whiskey", "november", "346", "gulf"], NoProtection);
