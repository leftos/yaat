...
public class CfrDepartureServiceTests
{
    ...
    {
        AircraftState ac = GroundDeparture();
        string echo = CfrDepartureService.Apply(ac, new CfrDepartureCommand(1830, CfrAction.Set), Utc(18, 0));
    ...
    {
        AircraftState ac = GroundDeparture();
        DateTime now = Utc(18, 0);
        string echo = CfrDepartureService.Apply(ac, new CfrDepartureCommand(null, CfrAction.Set), now);
    ...
    public void Apply_Clear_RemovesWindow()
    {
        ...
        string echo = CfrDepartureService.Apply(ac, new CfrDepartureCommand(null, CfrAction.Clear), default);
    ...
    public void CfrCountdown_Evaluate_PhaseAndSeconds(int h, int mi, int sec, CfrPhase phase, int seconds)
    {
        ...
        CfrRemaining r = CfrCountdown.Evaluate(window, Utc(h, mi).AddSeconds(sec));
