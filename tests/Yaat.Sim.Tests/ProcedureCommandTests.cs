...
public class ProcedureCommandTests
{
    ...
    public void Cvia_EnablesSidViaMode()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ClimbViaCommand(null), aircraft, null, null, null, Logger);
    ...
    public void Cvia_WithAltitude_SetsCeiling()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ClimbViaCommand(19000), aircraft, null, null, null, Logger);
    ...
    public void Dvia_EnablesStarViaMode()
    {
        ...
        var result = CommandDispatcher.Dispatch(new DescendViaCommand(null), aircraft, null, null, null, Logger);
    ...
    public void Dvia_WithAltitude_SetsFloor()
    {
        ...
        var result = CommandDispatcher.Dispatch(new DescendViaCommand(10000), aircraft, null, null, null, Logger);
    ...
    public void Cm_DisablesSidViaMode_PreservesLateralPath()
    {
        ...
        var result = CommandDispatcher.Dispatch(new ClimbMaintainCommand(35000), aircraft, null, null, null, Logger);
    ...
    public void Dm_DisablesStarViaMode_PreservesLateralPath()
    {
        ...
        var result = CommandDispatcher.Dispatch(new DescendMaintainCommand(10000), aircraft, null, null, null, Logger);
    ...
    public void Fh_ClearsEntireProcedure()
    {
        ...
        var result = CommandDispatcher.Dispatch(new FlyHeadingCommand(270), aircraft, null, null, null, Logger);
    ...
    public void Dct_ClearsEntireProcedure()
    {
        ...
        var result = CommandDispatcher.Dispatch(new DirectToCommand(fixes), aircraft, null, null, null, Logger);
    ...
    public void TurnLeft_ClearsEntireProcedure()
    {
        ...
        var result = CommandDispatcher.Dispatch(new TurnLeftCommand(180), aircraft, null, null, null, Logger);
    ...
    public void TurnRight_ClearsEntireProcedure()
    {
        ...
        var result = CommandDispatcher.Dispatch(new TurnRightCommand(90), aircraft, null, null, null, Logger);
    ...
    public void Fh_WithoutAltitude_WarnsWhenClearingProcedure()
    {
        ...
        CommandDispatcher.Dispatch(new FlyHeadingCommand(270), aircraft, null, null, null, Logger);
    ...
    public void Fh_WithAltitude_InCompound_NoWarning()
    {
        ...
        CommandDispatcher.DispatchCompound(compound, aircraft, null, null, null, Logger);
    ...
    public void TurnLeft_WithoutAltitude_WarnsWhenClearingProcedure()
    {
        ...
        CommandDispatcher.Dispatch(new TurnLeftCommand(270), aircraft, null, null, null, Logger);
    ...
    public void Cm_ClearingViaMode_NoWarning()
    {
        ...
        CommandDispatcher.Dispatch(new ClimbMaintainCommand(35000), aircraft, null, null, null, Logger);
