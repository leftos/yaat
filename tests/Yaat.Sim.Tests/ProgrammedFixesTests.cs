...
public class ProgrammedFixesTests
{
    ...
    public void Dct_ToProgrammedFix_Accepted()
    {
        ...
        var result = CommandDispatcher.Dispatch(cmd, aircraft, null, null, fixes, Logger, validateDctFixes: true);
    ...
    public void Dct_ToExpectedApproachFix_Accepted()
    {
        ...
        var result = CommandDispatcher.Dispatch(cmd, aircraft, null, null, fixes, Logger, approachLookup, validateDctFixes: true);
    ...
    public void Dct_ValidationDisabled_AllowsNonProgrammedFix()
    {
        ...
        var result = CommandDispatcher.Dispatch(cmd, aircraft, null, null, fixes, Logger, validateDctFixes: false);
