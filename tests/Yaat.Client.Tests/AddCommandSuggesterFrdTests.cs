...
public class AddCommandSuggesterFrdTests
{
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @AAAME093002", []);

        SuggestionItem item = Assert.Single(suggestions, s => s.Text == "@AAAME093002");
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @ZZZZZ093002", []);

        SuggestionItem item = Assert.Single(suggestions, s => s.Text == "@ZZZZZ093002");
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @AAAME093", []);

        SuggestionItem item = Assert.Single(suggestions, s => s.Text == "@AAAME093");
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @AAAME999002", []);

        SuggestionItem item = Assert.Single(suggestions, s => s.Text == "@AAAME999002");
    ...
    public void PositionSlot_RadialShapedParkingName_UnknownAnchor_NoFrdRow()
    {
        ...
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @GA101", ["GA101"]);
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @22", ["22"]);
    ...
    public void AltitudeSlot_AfterFullFrdToken_HintsAltitudeRequired()
    {
        ...
        SuggestionItem item = Assert.Single(suggestions, s => s.Text == "{altitude}");
    ...
    {
        ObservableCollection<SuggestionItem> suggestions = Suggest("ADD V S P @H1 ", []);
