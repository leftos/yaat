...
public class AircraftSpeechBubbleTests
{
    ...
    {
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(text, 1.0);
    ...
    {
        // 60 chars → 2 + 5 = 7 s
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(new string('x', 60), 1.0);
    ...
    public void ComputeDuration_LongText_ClampsToTwelveSeconds()
    {
        ...
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(new string('x', 200), 1.0);
    ...
    {
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(new string('x', 10_000), 1.0);
        Assert.Equal(12.0, d.TotalSeconds, precision: 3);
    }
    ...
    {
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(new string('x', length), multiplier);
    ...
    public void ComputeDuration_NonPositiveMultiplier_FallsBackToOne(double multiplier)
    {
        ...
        TimeSpan d = AircraftSpeechBubble.ComputeDuration(new string('x', 60), multiplier);
        Assert.Equal(7.0, d.TotalSeconds, precision: 3);
    }
    ...
    {
        AircraftSpeechBubble? bubble = Build();
    ...
    {
        AircraftSpeechBubble? bubble = Build(kind: TerminalEntryKind.PilotSpeech, message: "Clear of 28R");
    ...
    {
        AircraftSpeechBubble? bubble = Build(message: new string('x', 60), durationMultiplier: 2.0);
    ...
    {
        AircraftSpeechBubble? bubble = Build(showWarningBubbles: true, kind: TerminalEntryKind.Warning, message: "queue cleared");
    ...
    public void TryBuild_WarningKind_InSoloMode_StillShown()
    {
        ...
        AircraftSpeechBubble? bubble = Build(showWarningBubbles: true, soloMode: true, kind: TerminalEntryKind.Warning, message: "queue cleared");
    ...
    {
        AircraftSpeechBubble? bubble = Build(showWarningBubbles: true, kind: TerminalEntryKind.Say);
    ...
    public void TryBuild_StayUntilClicked_SetsMaxValueExpiry()
    {
        ...
        AircraftSpeechBubble? bubble = Build(stayUntilClicked: true);
    ...
    public void TryBuild_StayUntilClicked_WarningBubble_AlsoSticky()
    {
        ...
        AircraftSpeechBubble? bubble = Build(
            showWarningBubbles: true,
            kind: TerminalEntryKind.Warning,
            message: "queue cleared",
            stayUntilClicked: true
        );
    ...
    public void TryBuild_StayUntilClicked_Off_UsesComputedDuration()
    {
        ...
        AircraftSpeechBubble? bubble = Build(stayUntilClicked: false);
