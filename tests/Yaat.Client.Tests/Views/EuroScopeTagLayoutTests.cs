...
public class EuroScopeTagLayoutTests
{
    ...
    public void HasModeCField_WhenTransponderModeIsStandby()
    {
        ...
        TagFieldRect modeC = Assert.Single(result.Fields, f => f.Field == TagFieldId.ModeC);
    ...
    public void BoundsGrowByExactlyLineHeight_WhenStandby_NoLine4Fields()
    {
        ...
        ac.TransponderMode = "C";
        EuroScopeTagResult charlie = EuroScopeTagLayout.Layout(
            ac,
            originX: 100,
            originY: 100,
            style,
        ...
        ac.TransponderMode = "Standby";
        EuroScopeTagResult standby = EuroScopeTagLayout.Layout(
            ac,
            originX: 100,
            originY: 100,
            style,
    ...
    public void ModeCSitsBelowLine3_WhenLine4Empty()
    {
        ...
        TagFieldRect line3 = Assert.Single(result.Fields, f => f.Field == TagFieldId.CurrentAltitude);
        TagFieldRect modeC = Assert.Single(result.Fields, f => f.Field == TagFieldId.ModeC);
    ...
    public void ModeCSitsBelowLine4_WhenLine4Present()
    {
        ...
        TagFieldRect rwy = Assert.Single(result.Fields, f => f.Field == TagFieldId.AssignedRunway);
        TagFieldRect modeC = Assert.Single(result.Fields, f => f.Field == TagFieldId.ModeC);
    ...
    public void NoLandingClearance_BoundsReserveSpaceEvenDuringOffPhase()
    {
        ...
        ac.NoLandingClearanceWarningActive = false;
        EuroScopeTagResult baseline = EuroScopeTagLayout.Layout(
            ac,
            originX: 100,
            originY: 100,
            style,
    ...
    public void TypeCwtField_FallsBackToPhysicalType_WhenFiledIsBlank()
    {
        ...
        TagFieldRect typeCwt = Assert.Single(result.Fields, f => f.Field == TagFieldId.TypeCwt);
    ...
    public void NoteField_AppearsAtBottom_AndGrowsBounds_WhenSet()
    {
        ...
        ac.Note = "Watch wake";
        EuroScopeTagResult withNote = EuroScopeTagLayout.Layout(
            ac,
            originX: 100,
            originY: 100,
            style,
        ...
        TagFieldRect note = Assert.Single(withNote.Fields, f => f.Field == TagFieldId.Note);
    ...
    public void SquawkField_Present_WhenAssignedDiffersAndModeC()
    {
        ...
        TagFieldRect squawk = Assert.Single(result.Fields, f => f.Field == TagFieldId.Squawk);
