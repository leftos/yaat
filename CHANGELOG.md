...
### Fixed
- A VFR aircraft told to follow traffic that is then sent to extend its downwind now extends its own downwind to stay behind it, instead of turning base at its normal point and rolling out on final ahead of the aircraft it was sequencing behind.
