...
| [x] | **M10.7** | [m10.7-session-report-separation-scoring.md](m10.7-session-report-separation-scoring.md) | Live Session Report + FAA-grounded airborne and same-runway separation scoring |
