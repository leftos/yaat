...
**Date:** 2026-05-28
**Scope:** Code and docs review of `TaxiPathfinderV2` and `src/Yaat.Sim/Data/Airport/V2/*` vs legacy `TaxiPathfinder.cs`. Not a full release sign-off.
**Context at review time:** `TaxiPathfinderRouter.Current` defaults to `TaxiPathfinderV2`; v1 remains available via `TaxiPathfinderV1Adapter` / `UseV2 = false`.
...
A three-phase pipeline behind a thin facade (`TaxiPathfinderV2`, ~194 lines):
...
- `src/Yaat.Sim/Data/Airport/TaxiPathfinderV2.cs`
- `src/Yaat.Sim/Data/Airport/V2/AutoRouter.cs`
- `src/Yaat.Sim/Data/Airport/V2/SegmentExpander.cs`
- `src/Yaat.Sim/Data/Airport/V2/RouteCostFunction.cs`
- `src/Yaat.Sim/Data/Airport/V2/GeometricAdmissibility.cs`
- `src/Yaat.Sim/Data/Airport/V2/SearchContext.cs`
- `src/Yaat.Sim/Data/Airport/V2/RouteMaterialiser.cs`
