...
**Status:** top priority (steer 2026-09-02; controller AI waits). Steps 1–3 and 3d-0 … 3d-5b-2 shipped; **3d-5b-3 is next** (the host-slot records), then the 3d-6 docs pass — the plan is in [03d-action-router.md](./03d-action-router.md) § 3d-5b.
...
| 3d. The action router (3d-0 … 3d-6) | [03d-action-router.md](./03d-action-router.md) | 3d-0 … 3d-5b-2 shipped 2026-09-06; 3d-5b-3 next; 3d-6 docs after it |
