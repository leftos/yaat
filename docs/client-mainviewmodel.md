...
| `MainViewModel.Timeline.cs` | Rewind / recording / export-progress; the command-marker buffer (`_commandMarkerHistory` + `_commandMarkerLock`); timeline-marker poll (`RefreshTimelineMarkersAsync`). |
