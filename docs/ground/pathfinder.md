...
- **`ExplicitPathOptions`** (class) — holds optional hints for `ResolveExplicitPath`: `ExplicitHoldShorts` (list of runway ids), `DestinationRunway`, `DestinationHintNode`, `DiagnosticLog` (callback for troubleshooting), `AirportId`.
