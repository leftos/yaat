...
Commands/TrackEngine.cs             # Pure domain logic for STARS track ops: Track, Drop, Handoff, Accept, Cancel, PointOut, Acknowledge,
                                    ...
                                    # AcknowledgeConflictAlert(ac, conflicts): CAACK on the engine's conflict-alert set
...
IActionHost.cs                 # The action-path view of a host, part of ISimulationHost: slots for the bodies the server still owns (ApplyStrip, ApplyTdls,
                               ...
                               # ApplyTransport, ApplyRecordedAsdexMutation / ApplyRecordedSaidMutation for the recorded CRC display
