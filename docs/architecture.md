...
SimulationEngine.TrackAutomation.cs # Track automation on every run kind. ApplyAutoTrackConditions(loaded): a scenario aircraft's autoTrackConditions or a generator's
                                   ...
                                   # TickDelayedHandoffs (pre-physics; a target folded under an attended TCP waits), TickAutoAccept + TickPointoutAutoAck (post-physics;
                                   ...
                                   # per Attendance, the student's own in solo mode, or a live-feed owner), TickFlightPlanCreatorAutoTrack (an untracked aircraft
                                   ...
                                   # → the autoTrackAirportIds position). The [AutoTrack]/[AutoAccept]/[AutoAck] lines go through EmitTerminal
