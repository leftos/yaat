...
The architecture/scope decisions in [`docs/vtdls/emulation-design.md`](./emulation-design.md) trace back to specific sections of `vtdls.md`. The points the upstream confirms (some of which the plan originally left provisional):
