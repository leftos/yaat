...
Current scoring covers IFR radar separation, Class B/C VFR-related separation where applicable, Class C outer-area IFR/VFR advisory service using YAAT's 20 NM training approximation, same-runway, reciprocal, intersecting-runway, and wake events, structured traffic-advisory proof, safety-alert proof, field-in-sight proof, visual-follow states, and related runway/approach outcomes. VFR/VFR and other no-minima proximity cases can appear as Advisory / Visual findings rather than Separation findings.
