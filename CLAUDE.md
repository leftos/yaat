...
.NET 10, C# (nullable, implicit usings) | Avalonia UI 12.1.0 (Fluent dark, compiled bindings) | SkiaSharp 3.119.4 | CommunityToolkit.Mvvm 8.4.0 | SignalR.Client 10.0.3
...
- `D:\dev\crc-decompiled\CRC\` — private git repo of the ILSpy-decompiled CRC (2.15 baseline + 2.17; re-decompile + commit on each CRC update). Key: `Vatsim.Nas.Crc.Ui.Displays.Stars.Elements/DisplayElementTracks.cs`, `…Stars.Consolidation/ConsolidationManager.cs`, `…Stars.Tracks/Track.cs`, `TrackOwnerExtensions.cs`
