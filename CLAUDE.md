...
- Taxi (kts/s, physics is the only ground-speed integrator): accel 1.0 for every category — the breakaway rate, not the sustained idle rate (a light single's breakaway blip gives it *better* ground thrust-to-weight than a loaded transport, so it cannot be slower; re-reviewed 2026-09-15, piston/heli 0.6 → 1.0); brake Jet/TP 5.0, Piston/Heli 2.0. Ground snap window = one sub-tick of change.
