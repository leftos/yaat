...
- **TDD for bug fixes**: Use test-driven development for most issue fixes. Write the failing test first (unit or E2E per `docs/e2e-testing.md`), confirm it fails, apply the fix, then confirm it passes. This proves the test actually catches the bug.
